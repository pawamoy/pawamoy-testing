...
*Pawamoy Testing Insiders* can be installed with `pip` [using SSH][using ssh]:
...
Self-hosting the Insiders package makes it possible to depend on *Pawamoy Testing* normally,
...
with [Twine]:
  ...
  [Github Releases]: https://github.com/pawamoy-insiders/pawamoy-testing/releases
...
>
> Now when running `pip install pawamoy-testing`,
...
When upgrading Insiders, you should always check the version of *Pawamoy Testing*
